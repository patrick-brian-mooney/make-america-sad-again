...
<meta name="date" content="2017-01-19T04:00:14-0800" />
...
if 'tweet_text' in form:     # Then we're evaluating a previous quiz, and should provide feedback.
    print("""<div class="u-pull-right two-thirds column"><blockquote class="twitter-tweet" data-lang="en"><p lang="en" dir="ltr">%s</p>&mdash; (@%s) <a href="https://twitter.com/%s/status/%s">%s</a></blockquote>
<script async src="//platform.twitter.com/widgets.js" charset="utf-8"></script></div>""" % (form['tweet_text'].value, form['orig_account'].value, form['orig_account'].value, form['tweet_id'].value, form['tweet_date'].value))
